...
import SettlementDashboardScreen from '../auth/screens/home/SettlementDashboardScreen';
    ...
    >
      ...
      {userToken && !isGuest && (
        <>
          ...
          <Stack.Screen name="SettlementDashboardScreen" component={SettlementDashboardScreen} />
