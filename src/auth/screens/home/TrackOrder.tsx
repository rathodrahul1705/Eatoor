...
const SMALL_MAP_HEIGHT = 180;
const EXPANDED_MAP_HEIGHT = height * 0.7;
      ...
      try {
        ...
        if (response.status === 200 && response.data.orders?.length > 0) {
          ...
          switch (orderData.status) {
            case 'Pending': setDeliveryStatus(DELIVERY_STATUS.PREPARING); break;
            case 'Out for Delivery': setDeliveryStatus(DELIVERY_STATUS.ON_THE_WAY); break;
            case 'Delivered': setDeliveryStatus(DELIVERY_STATUS.DELIVERED); break;
            default: setDeliveryStatus(DELIVERY_STATUS.PREPARING);
          }
